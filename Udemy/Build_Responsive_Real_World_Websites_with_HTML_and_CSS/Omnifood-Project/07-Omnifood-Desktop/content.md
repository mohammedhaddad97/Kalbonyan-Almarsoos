...
###
    ...
    - Logo + Navigation
    - Hero
    - Featured in (Mostly placed right after the hero section, or even inside the hero section)
    - How it works?
    - Meals (And list of diets)
    - Testimonials + Gallery (Side by side)
    - Pricing (It's also common these days to put the pricing low on the page, right before call to actions) + Features
    - Call to action (Mostly is placed right before the footer)
    - Footer
